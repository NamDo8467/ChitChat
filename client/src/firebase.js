...
import { getFirestore, query, where, doc, getDocs, getDoc, addDoc, collection } from "firebase/firestore";
...
export { app, auth, db, googleProvider, signInWithPopup, query, where, collection, doc, getDoc, getDocs, addDoc };
